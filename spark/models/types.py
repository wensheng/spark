"""Types for Spark LLM models

These types are adapted from Strands Agents SDK
"""
...
class Message(TypedDict, extra_items=Any):
...
class ChatCompletionTextObject(TypedDict):
    """A text object in a chat completion."""
...
class ChatCompletionThinkingBlock(TypedDict, total=False):
    """A thinking block in a chat completion."""
...
class ChatCompletionToolCallFunctionChunk(TypedDict, total=False):
    """A function call chunk in a chat completion."""
...
class ChatCompletionAssistantMessage(TypedDict, total=False):
    ...
    content: Optional[Union[str, Iterable[Union[ChatCompletionTextObject, ChatCompletionThinkingBlock]]]]
    name: Optional[str]
